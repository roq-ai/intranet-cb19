...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'employee', 'manager', 'hr-representative', 'it-support'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Blogs', path: '/blogs', entity: 'blog', service: AccessServiceEnum.PROJECT, icon: FiBookOpen },
    {
      name: 'Chat Bots',
      path: '/chat-bots',
      entity: 'chat_bot',
    ...
    { name: 'Forums', path: '/forums', entity: 'forum', service: AccessServiceEnum.PROJECT, icon: FiMessageCircle },
    { name: 'News', path: '/news', entity: 'news', service: AccessServiceEnum.PROJECT, icon: FiFileText },
    { name: 'Rewards', path: '/rewards', entity: 'reward', service: AccessServiceEnum.PROJECT, icon: FiGift },
    { name: 'Vlogs', path: '/vlogs', entity: 'vlog', service: AccessServiceEnum.PROJECT, icon: FiVideo },
