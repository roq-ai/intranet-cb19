  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Intranet - Empowering 5000 employees with dynamic interaction, chat bots, reward recognition, blogs, vlogs, forums, and celebrating milestones together."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxpbnRyYW5ldHxlbnwwfHx8fDE2OTE3NTI1MTl8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Intranet - Empowering 5000 employees with dynamic interaction, chat bots, reward recognition, blogs, vlogs, forums, and celebrating milestones together.`}
            </Text>
            <Box
